...
class indexModel {
    ...
    public function getMensajeApi($id=""){
        $mensajes=array(
            ""=>"API - para Prueba de Multiplicatalent Colores.",
            "errorUser"=>"ERR-1001: Usuario o clave incorrecta",
            "errorIDrow"=>"ERR-1002: El Id del color no existe",
            "success"=>"SUCCESS - Datos completos.",
            "errorQuery"=>"ERR-1003: No existen datos contactar al administrador",
            "errorUserMethod"=>"ERR-1004: Este usuario solo puede usar el método GET ",
            "successDelete"=>"SUCCESS - Se elimino el registro"
        );
        $cad = $mensajes[$id];
        return $cad;
    }
